...
public class InsertarSitioFragment extends DialogFragment {
  ...
  /*  @NonNull
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EditText desplegable = (EditText) v.findViewById(R.id.registrar_sitio_PotenciaPanel);

        btnAgregar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(camposVacios(txtNombre,txtRadiacion,txtMes1,txtMes2,txtMes3,txtMes4,txtMes5,txtMes6, desplegable)){
                    new Mensajes(view.getContext()).toast("Digite los datos en blanco");
                }else{
                    long id = insertar(txtNombre,txtLatitud,txtLongitud,txtRadiacion,txtMes1,txtMes2,
                            txtMes3,txtMes4,txtMes5,txtMes6, desplegable, v);
...
*/
    ...
    public boolean camposVacios(EditText nombres, EditText radiacion, EditText mes1, EditText mes2,
        ...
        if (nombres.getText().toString().isEmpty() ||
                ...
                sp_panel.getText().toString().isEmpty()){
            vacios = true; }
        return vacios;
    }
    ...
    private long insertar(EditText nombres, TextView latitud, TextView longitud,
                          EditText radiacion, EditText mes1, EditText mes2,
                          EditText mes3, EditText mes4, EditText mes5, EditText mes6,
