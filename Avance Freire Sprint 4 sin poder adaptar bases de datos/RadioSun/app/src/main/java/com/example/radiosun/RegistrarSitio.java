...
public class RegistrarSitio extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnInsertar = (Button) findViewById(R.id.insertarsitio_btnagregar);
        TextView txtPaneles = (TextView) findViewById(R.id.registrositio_Respuesta);
        TextView desplegable = (TextView) findViewById(R.id.registrar_sitio_PotenciaPanel);
    ...
    public String paneles(EditText radiacion,EditText mes1, EditText mes2, EditText mes3,
                            EditText mes4, EditText mes5, EditText mes6, TextView sp_panel){
